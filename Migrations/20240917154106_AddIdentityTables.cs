    ...
    public partial class AddIdentityTables : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                table: "Loggin",
                newName: "IX_Loggin_UserId");

            migrationBuilder.RenameIndex(
                name: "IX_Loggins_AuthenticationId1",
                table: "Loggin",
                newName: "IX_Loggin_AuthenticationId1");

            migrationBuilder.RenameIndex(
                name: "IX_Loggins_AuthenticationId",
                table: "Loggin",
                newName: "IX_Loggin_AuthenticationId");

            migrationBuilder.RenameIndex(
                name: "IX_Authentications_UserId",
                table: "Authentication",
                newName: "IX_Authentication_UserId");
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.RenameIndex(
                ...
                table: "Loggins",
                newName: "IX_Loggins_UserId");

            migrationBuilder.RenameIndex(
                name: "IX_Loggin_AuthenticationId1",
                table: "Loggins",
                newName: "IX_Loggins_AuthenticationId1");

            migrationBuilder.RenameIndex(
                name: "IX_Loggin_AuthenticationId",
                table: "Loggins",
                newName: "IX_Loggins_AuthenticationId");
